package com.example.sureshvasudev.activityinteraction.controller;
...
import com.example.sureshvasudev.activityinteraction.model.Question;
import android.util.Log;


import com.example.sureshvasudev.activityinteraction.R;

public class QuizActivity extends AppCompatActivity  implements View.OnClickListener {


    private static final String TAG = "MULTI_ACTIVITY_QUIZ";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(QUIZ_INDEX_KEY,questionIndex);
